...
def parse_configure(model=None, dataset=None):
    ...
    parser.add_argument('--emb', type=str, default='np', help='emb type')
    ...
    with open('./encoder/config/modelconf/{}.yml'.format(model_name), encoding='utf-8') as f:
        ...
        # semantic embeddings
        usrprf_embeds_path = "./data/{}/usr_emb_{}.pkl".format(configs['data']['name'], args.emb)
        itmprf_embeds_path = "./data/{}/itm_emb_{}.pkl".format(configs['data']['name'], args.emb)
