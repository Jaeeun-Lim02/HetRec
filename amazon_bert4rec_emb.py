...
full_seq_user = {}
with open("./data/amazon/seq_user_data.jsonl", "r", encoding="utf-8") as f:
    for line in f:
        obj = json.loads(line)
...
full_seq_item = {}
with open("./data/amazon/seq_item_data.jsonl", "r", encoding="utf-8") as f:
    for line in f:
        obj = json.loads(line)
        iid, seq = next(iter(obj.items()))
        full_seq_item[int(iid)] = seq

with open("./data/amazon/trn_mat.pkl", "rb") as f:
    trn_mat = pickle.load(f).tocsr()
with open("./data/amazon/val_mat.pkl", "rb") as f:
...
with open("./data/amazon/usr_emb_bert4rec_raw.pkl", "wb") as f:
    pickle.dump(user_emb_raw, f)
with open("./data/amazon/itm_emb_bert4rec_raw.pkl", "wb") as f:
